...
import { Sparkles, ChevronRight, Star, TrendingUp, Brain } from "lucide-react";
...
type CreateOption = {
  ...
  description: string;
  type: "template" | "creative-ai" | "create-scratch";
  highlight?: boolean;
};
                ...
                <div className="flex-1">
                  <h3 className="font-bold text-sm sm:text-base mb-1">
                    ...
                    <motion.span
                      ...
                      className="bg-gradient-to-r from-primary via-purple-600 to-primary bg-clip-text text-transparent  text-3xl"
